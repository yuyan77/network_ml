...
def train(raw_file, train_words_file):

    if not os.path.exists("./data/train_data/{}.csv".format(train_words_file)):
        dp.initial_part_words("./data/raw_data/{}.txt".format(raw_file))

    request_input, history_inputs, candidate_inputs, vm_id, label = dp.get_train_inputs(train_words_file)
